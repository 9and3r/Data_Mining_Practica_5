...
public class WekaSVM {
	...
	*/
		...
		//definimos los valores de los par�metros

		String[] kernelString = { "linear: u'*v",
				"Polynomial: (gamma*u'*v + coef0)^degree",
				"radial basis function: exp(-gamma*|u-v|²)",
		...
		for (int degreea = 0; degreea <= 4; degreea++) {
			...
			for (int kernela = 0; kernela < 4; kernela++) {
				...
				for (int tipoa = 0; tipoa < 5; tipoa++) {
					...
					System.out.println("ESTIMATZAILEA PARAMETROAK:\n\n");
					System.out.println("degree: " + estimador.getDegree());
					System.out.println("kernela: " + estimador.getKernelType());
					System.out.println("svmtipoa: " + estimador.getSVMType());
